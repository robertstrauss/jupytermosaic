...
.mosaic-Notebook {
  ...
  /* Width of the drop gutter between two adjacent groups. */
  --mosaic-gutter: 10px;
...
/* The cell toolbar hides itself whenever it would reach past the middle of the
   ...
   the insert-left/right buttons widened it. Keep it, and give it a background
   so it stays legible over whatever it covers. */
.mosaic-Notebook .jp-cell-toolbar {
...
/* A seam between two groups has no cell on it to drop onto, so it gets a track
   of its own. The rule also distinguishes a row of columns from a column of
   rows at a glance. Seams that touch a cell need neither: that cell is already
   the drop target. */
.mosaic-gutter {
  position: absolute;
  top: 0;
...
//# sourceMappingURL=style_index_js.d32dfbbce90a14cd91e5.js.map