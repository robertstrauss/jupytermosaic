...
.mosaic-Notebook {
  ...
  /* The rule drawn in the gap between two adjacent groups. */
  --mosaic-gutter-rule: rgb(0 0 0 / 20%);
...
.mosaic-Notebook .jp-WindowedPanel-viewport.mosaic-grid {
  ...
  /* The fitted width in MosaicGrid is a border-box figure: tracks plus the
     edge padding. */
...
.mosaic-Notebook .jp-Cell {
  /* The narrowest a cell may be drawn is enforced on the grid as a whole, by
     \`minGridWidth\`; a floor here would instead be a floor on the cell's grid
     track, which is exactly what stopped equal partitions coming out equal. */
  min-width: 0;
  min-height: 0;
  box-sizing: border-box;
  margin: 0;
...
/* The stock footer is indented to line up with a linear notebook's cell
   content, past the prompt and collapser. Cells here start at the grid's edge,
   so it needs to span the same width they do. */
.mosaic-Notebook .jp-Notebook-footer {
  margin-left: var(--mosaic-edge-padding);
  width: calc(100% - 2 * var(--mosaic-edge-padding));
}

/* The cell toolbar hides itself whenever it would reach past the middle of the
   editor, which in a tiled layout means most cells -- and more of them since
   the insert-left/right buttons widened it. Keep it shown. */
.mosaic-Notebook .jp-toolbar-overlap .jp-cell-toolbar {
  display: flex;
}

/* -- gutters between adjacent groups -------------------------------------- */

/* A seam between two groups has no cell on it to drop onto, so it gets a
   gutter: a target laid over the ordinary gap that already separates the two
   tracks, taking no space of its own. Seams that touch a cell need none -- that
   cell is already the drop target.

   Every gutter takes a drop, but only one kind carries a drawn rule: where two
   parallel groups meet -- a row above a row, a column beside a column -- which
   is the one arrangement the eye cannot resolve on its own. At a group's outer
   edge there is nothing to disambiguate, so the gutter is there but invisible
   until a drag proposes landing on it. */
.mosaic-gutter {
  position: absolute;
  top: 0;
  left: 0;
...
.mosaic-gutter-seam::after {
  background-color: var(--mosaic-gutter-rule);
}

.mosaic-gutter[data-mosaic-axis='col']::after {
  width: 100%;
  height: 1px;
}

.mosaic-gutter[data-mosaic-axis='row']::after {
  width: 1px;
  height: 100%;
}

.mosaic-gutter-active::after {
  background-color: var(--jp-brand-color1);
}

.mosaic-gutter-active[data-mosaic-axis='col']::after {
  height: 4px;
}

.mosaic-gutter-active[data-mosaic-axis='row']::after {
  width: 4px;
}

/* The rule reads against either theme: dark on light, light on dark. */
:where(body[data-jp-theme-light='false']) .mosaic-Notebook {
  --mosaic-gutter-rule: rgb(255 255 255 / 20%);
}
...
/* A drop target gets a solid top border from the stock notebook stylesheet,
   which reads as a second, contradictory indicator next to the directional one
   below. Hide it without changing the border width, so nothing shifts. */
...
`, "",{"version":3,"sources":["webpack://./style/mosaic.css"],"names":[],"mappings":"AAAA;;;;;;;;;EASE;;AAEF;EACE,8BAA8B;EAC9B,iBAAiB;;EAEjB,2DAA2D;EAC3D,sCAAsC;;EAEtC;mEACiE;EACjE,0BAA0B;EAC1B,4CAA4C;EAC5C,gBAAgB;AAClB;;AAEA;8EAC8E;AAC9E;EACE,aAAa;EACb,oBAAoB;EACpB,sBAAsB;;EAEtB;oBACkB;EAClB,sBAAsB;EACtB,mCAAmC;EACnC,OAAO;EACP,QAAQ;EACR,WAAW;AACb;;AAEA;EACE,kBAAkB,EAAE,2CAA2C;AACjE;;AAEA;EACE;;8EAE4E;EAC5E,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,SAAS;AACX;;AAEA;uDACuD;AACvD;EACE,gBAAgB;AAClB;;AAEA,6EAA6E;;AAE7E;EACE,kBAAkB;EAClB,QAAQ;EACR,gBAAgB;EAChB,oBAAoB;EACpB,UAAU;AACZ;;AAEA;EACE,kBAAkB;EAClB,MAAM;EACN,OAAO;EACP,sBAAsB;EACtB,6BAA6B;EAC7B,kBAAkB;EAClB,oBAAoB;EACpB,8BAA8B;AAChC;;AAEA;;;EAGE,uCAAuC;AACzC;;AAEA;EACE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,WAAW;EACX,YAAY;EACZ,UAAU;EACV,YAAY;EACZ,kBAAkB;EAClB,wCAAwC;EACxC,+BAA+B;EAC/B,eAAe;EACf,iBAAiB;EACjB,eAAe;EACf,UAAU;EACV,oBAAoB;EACpB,wBAAwB;AAC1B;;AAEA;EACE,UAAU;AACZ;;AAEA;wDACwD;AACxD;;EAEE,yBAAyB;AAC3B;;AAEA;;gDAEgD;AAChD;EACE,uCAAuC;EACvC,kDAAkD;AACpD;;AAEA;;6DAE6D;AAC7D;EACE,aAAa;AACf;;AAEA,8EAA8E;;AAE9E;;;;;;;;;yCASyC;AACzC;EACE,kBAAkB;EAClB,MAAM;EACN,OAAO;EACP,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,oBAAoB;AACtB;;AAEA;EACE,WAAW;EACX,6BAA6B;AAC/B;;AAEA;EACE,2CAA2C;AAC7C;;AAEA;EACE,WAAW;EACX,WAAW;AACb;;AAEA;EACE,UAAU;EACV,YAAY;AACd;;AAEA;EACE,wCAAwC;AAC1C;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,UAAU;AACZ;;AAEA,uEAAuE;AACvE;EACE,4CAA4C;AAC9C;;AAEA,8EAA8E;;AAE9E;EACE,kBAAkB;EAClB,oBAAoB;EACpB,wCAAwC;EACxC,kBAAkB;AACpB;;AAEA;EACE,MAAM;EACN,SAAS;EACT,QAAQ;EACR,UAAU;AACZ;;AAEA;EACE,OAAO;EACP,QAAQ;EACR,SAAS;EACT,WAAW;AACb;;AAEA;EACE,kBAAkB;EAClB,MAAM;EACN,OAAO;EACP,wCAAwC;EACxC,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,gBAAgB;EAChB,wCAAwC;AAC1C;;AAEA;;;EAGE,WAAW;AACb;;AAEA;;;EAGE,YAAY;AACd;;AAEA,8EAA8E;;AAE9E;EACE,kBAAkB;EAClB,MAAM;EACN,OAAO;EACP,QAAQ;EACR,aAAa;EACb,QAAQ;EACR,gBAAgB;EAChB,oBAAoB;EACpB,yCAAyC;EACzC,0BAA0B;AAC5B;;AAEA;EACE,gBAAgB;EAChB,kCAAkC;EAClC,qCAAqC;EACrC,+BAA+B;EAC/B,mBAAmB;EACnB,eAAe;EACf,0BAA0B;AAC5B;;AAEA;EACE,yCAAyC;AAC3C;;AAEA;EACE,yCAAyC;EACzC,+BAA+B;EAC/B,gBAAgB;AAClB;;AAEA,8EAA8E;;AAE9E;;yEAEyE;AACzE;;;EAGE,6BAA6B;AAC/B;;AAEA;EACE,WAAW;EACX,kBAAkB;EAClB,wCAAwC;EACxC,kBAAkB;EAClB,UAAU;EACV,oBAAoB;AACtB;;AAEA;;EAEE,MAAM;EACN,OAAO;EACP,QAAQ;EACR,WAAW;AACb;;AAEA;;EAEE,SAAS;EACT,OAAO;EACP,QAAQ;EACR,WAAW;AACb;;AAEA;;EAEE,MAAM;EACN,SAAS;EACT,OAAO;EACP,UAAU;AACZ;;AAEA;;EAEE,MAAM;EACN,SAAS;EACT,QAAQ;EACR,UAAU;AACZ;;AAEA,8EAA8E;;AAE9E;EACE,uBAAuB;EACvB,gBAAgB;;EAEhB,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,uCAAuC;EACvC,0CAA0C;EAC1C,mBAAmB;AACrB;;AAEA;EACE,6DAA6D;EAC7D;;GAEC;AACH;;AAEA,gFAAgF;AAChF;EACE,mCAAmC;AACrC;;AAEA,2EAA2E;AAC3E;EACE,WAAW;EACX,YAAY;EACZ,6BAA6B;AAC/B;AACA;EACE,gBAAgB;AAClB;AACA;;EAEE,iCAAiC;AACnC;AACA;;;EAGE;AACF;EACE,0BAA0B;AAC5B;AACA;EACE,gBAAgB;EAChB,kBAAkB;EAClB,cAAc;EACd,WAAW;AACb;AACA;EACE,WAAW;EACX,kBAAkB;EAClB,gBAAgB;EAChB,cAAc;EACd,UAAU;AACZ;AACA;EACE,gBAAgB,EAAE,yCAAyC;AAC7D;;AAEA,wCAAwC;AACxC;EACE,qBAAqB;AACvB","sourcesContent":["/**\n * Jupyter Mosaic layout.\n *\n * The notebook viewport is a single flat CSS grid: every cell is a direct child\n * of `.jp-WindowedPanel-viewport` and is positioned by `grid-row`/`grid-column`\n * computed in MosaicGrid.ts. There are no nested containers -- the notebook's\n * windowed layout binary-searches every viewport child for a windowing index\n * and hangs on anything else. Group chrome therefore lives in `.mosaic-overlay`,\n * a sibling of the viewport.\n */\n\n.mosaic-Notebook {\n  --mosaic-cell-min-width: 160px;\n  --mosaic-gap: 8px;\n\n  /* The rule drawn in the gap between two adjacent groups. */\n  --mosaic-gutter-rule: rgb(0 0 0 / 20%);\n\n  /* Sampled once by WindowedList on attach and folded into the document\n     height, so this must not vary with the layout-style setting. */\n  --mosaic-edge-padding: 8px;\n  --mosaic-frame-color: rgb(128 128 128 / 35%);\n  --cell-margin: 0;\n}\n\n/* The viewport is the grid. Windowing keeps it absolutely positioned; the\n   getSpan override pins it to the top so grid lines stay in document space. */\n.mosaic-Notebook .jp-WindowedPanel-viewport.mosaic-grid {\n  display: grid;\n  align-items: stretch;\n  gap: var(--mosaic-gap);\n\n  /* The fitted width in MosaicGrid is a border-box figure: tracks plus the\n     edge padding. */\n  box-sizing: border-box;\n  padding: var(--mosaic-edge-padding);\n  left: 0;\n  right: 0;\n  width: auto;\n}\n\n.mosaic-Notebook .jp-WindowedPanel-inner {\n  position: relative; /* containing block for the overlay plane */\n}\n\n.mosaic-Notebook .jp-Cell {\n  /* The narrowest a cell may be drawn is enforced on the grid as a whole, by\n     `minGridWidth`; a floor here would instead be a floor on the cell's grid\n     track, which is exactly what stopped equal partitions coming out equal. */\n  min-width: 0;\n  min-height: 0;\n  box-sizing: border-box;\n  margin: 0;\n}\n\n/* Cells inside a scrolling or tabbed group are positioned by hand against the\n   group's grid area, so they must not stretch to it. */\n.mosaic-Notebook .jp-Cell.mosaic-managed {\n  overflow: hidden;\n}\n\n/* -- overlay plane ------------------------------------------------------- */\n\n.mosaic-overlay {\n  position: absolute;\n  inset: 0;\n  overflow: hidden;\n  pointer-events: none;\n  z-index: 3;\n}\n\n.mosaic-frame {\n  position: absolute;\n  top: 0;\n  left: 0;\n  box-sizing: border-box;\n  border: 1px solid transparent;\n  border-radius: 6px;\n  pointer-events: none;\n  transition: border-color 0.15s;\n}\n\n.mosaic-frame:hover,\n.mosaic-frame[data-mosaic-mode='scroll'],\n.mosaic-frame[data-mosaic-mode='tabs'] {\n  border-color: var(--mosaic-frame-color);\n}\n\n.mosaic-frame-run {\n  position: absolute;\n  top: 2px;\n  left: 2px;\n  width: 20px;\n  height: 20px;\n  padding: 0;\n  border: none;\n  border-radius: 3px;\n  background-color: rgb(128 128 128 / 30%);\n  color: var(--jp-ui-font-color0);\n  font-size: 10px;\n  line-height: 20px;\n  cursor: pointer;\n  opacity: 0;\n  pointer-events: auto;\n  transition: opacity 0.2s;\n}\n\n.mosaic-frame:hover .mosaic-frame-run {\n  opacity: 1;\n}\n\n/* Insert-left/right reuse the insert-above/below icons, turned a quarter turn\n   so the arrow points the way the cell will be added. */\nsvg[data-icon='mosaic:add-left'],\nsvg[data-icon='mosaic:add-right'] {\n  transform: rotate(-90deg);\n}\n\n/* The stock footer is indented to line up with a linear notebook's cell\n   content, past the prompt and collapser. Cells here start at the grid's edge,\n   so it needs to span the same width they do. */\n.mosaic-Notebook .jp-Notebook-footer {\n  margin-left: var(--mosaic-edge-padding);\n  width: calc(100% - 2 * var(--mosaic-edge-padding));\n}\n\n/* The cell toolbar hides itself whenever it would reach past the middle of the\n   editor, which in a tiled layout means most cells -- and more of them since\n   the insert-left/right buttons widened it. Keep it shown. */\n.mosaic-Notebook .jp-toolbar-overlap .jp-cell-toolbar {\n  display: flex;\n}\n\n/* -- gutters between adjacent groups -------------------------------------- */\n\n/* A seam between two groups has no cell on it to drop onto, so it gets a\n   gutter: a target laid over the ordinary gap that already separates the two\n   tracks, taking no space of its own. Seams that touch a cell need none -- that\n   cell is already the drop target.\n\n   Every gutter takes a drop, but only one kind carries a drawn rule: where two\n   parallel groups meet -- a row above a row, a column beside a column -- which\n   is the one arrangement the eye cannot resolve on its own. At a group's outer\n   edge there is nothing to disambiguate, so the gutter is there but invisible\n   until a drag proposes landing on it. */\n.mosaic-gutter {\n  position: absolute;\n  top: 0;\n  left: 0;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  pointer-events: none;\n}\n\n.mosaic-gutter::after {\n  content: '';\n  background-color: transparent;\n}\n\n.mosaic-gutter-seam::after {\n  background-color: var(--mosaic-gutter-rule);\n}\n\n.mosaic-gutter[data-mosaic-axis='col']::after {\n  width: 100%;\n  height: 1px;\n}\n\n.mosaic-gutter[data-mosaic-axis='row']::after {\n  width: 1px;\n  height: 100%;\n}\n\n.mosaic-gutter-active::after {\n  background-color: var(--jp-brand-color1);\n}\n\n.mosaic-gutter-active[data-mosaic-axis='col']::after {\n  height: 4px;\n}\n\n.mosaic-gutter-active[data-mosaic-axis='row']::after {\n  width: 4px;\n}\n\n/* The rule reads against either theme: dark on light, light on dark. */\n:where(body[data-jp-theme-light='false']) .mosaic-Notebook {\n  --mosaic-gutter-rule: rgb(255 255 255 / 20%);\n}\n\n/* -- simulated scrollbars ------------------------------------------------- */\n\n.mosaic-frame-scrollbar {\n  position: absolute;\n  pointer-events: auto;\n  background-color: rgb(128 128 128 / 12%);\n  border-radius: 4px;\n}\n\n.mosaic-frame[data-mosaic-axis='col'] > .mosaic-frame-scrollbar {\n  top: 0;\n  bottom: 0;\n  right: 0;\n  width: 8px;\n}\n\n.mosaic-frame[data-mosaic-axis='row'] > .mosaic-frame-scrollbar {\n  left: 0;\n  right: 0;\n  bottom: 0;\n  height: 8px;\n}\n\n.mosaic-frame-thumb {\n  position: absolute;\n  top: 0;\n  left: 0;\n  background-color: rgb(128 128 128 / 65%);\n  border-radius: 4px;\n  cursor: grab;\n}\n\n.mosaic-frame-thumb:active {\n  cursor: grabbing;\n  background-color: rgb(128 128 128 / 90%);\n}\n\n.mosaic-frame[data-mosaic-axis='col']\n  > .mosaic-frame-scrollbar\n  > .mosaic-frame-thumb {\n  width: 100%;\n}\n\n.mosaic-frame[data-mosaic-axis='row']\n  > .mosaic-frame-scrollbar\n  > .mosaic-frame-thumb {\n  height: 100%;\n}\n\n/* -- tab bars ------------------------------------------------------------- */\n\n.mosaic-frame-tabs {\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  display: flex;\n  gap: 2px;\n  overflow-x: auto;\n  pointer-events: auto;\n  background-color: var(--jp-layout-color2);\n  border-radius: 6px 6px 0 0;\n}\n\n.mosaic-tab {\n  padding: 2px 8px;\n  font-size: var(--jp-ui-font-size0);\n  font-family: var(--jp-ui-font-family);\n  color: var(--jp-ui-font-color1);\n  white-space: nowrap;\n  cursor: pointer;\n  border-radius: 4px 4px 0 0;\n}\n\n.mosaic-tab:hover {\n  background-color: var(--jp-layout-color3);\n}\n\n.mosaic-tab-active {\n  background-color: var(--jp-layout-color1);\n  color: var(--jp-ui-font-color0);\n  font-weight: 600;\n}\n\n/* -- drop indicators ------------------------------------------------------ */\n\n/* A drop target gets a solid top border from the stock notebook stylesheet,\n   which reads as a second, contradictory indicator next to the directional one\n   below. Hide it without changing the border width, so nothing shifts. */\n.mosaic-Notebook .jp-Notebook-cell.jp-mod-dropTarget,\n.mosaic-Notebook\n  .jp-Notebook-cell.jp-mod-active.jp-mod-selected.jp-mod-dropTarget {\n  border-top-color: transparent;\n}\n\n.mosaic-Notebook .jp-Cell.jp-mod-dropTarget::after {\n  content: '';\n  position: absolute;\n  background-color: var(--jp-brand-color1);\n  border-radius: 2px;\n  z-index: 4;\n  pointer-events: none;\n}\n\n.mosaic-Notebook\n  .jp-Cell.jp-mod-dropTarget[data-mosaic-drop-side='top']::after {\n  top: 0;\n  left: 0;\n  right: 0;\n  height: 3px;\n}\n\n.mosaic-Notebook\n  .jp-Cell.jp-mod-dropTarget[data-mosaic-drop-side='bottom']::after {\n  bottom: 0;\n  left: 0;\n  right: 0;\n  height: 3px;\n}\n\n.mosaic-Notebook\n  .jp-Cell.jp-mod-dropTarget[data-mosaic-drop-side='left']::after {\n  top: 0;\n  bottom: 0;\n  left: 0;\n  width: 3px;\n}\n\n.mosaic-Notebook\n  .jp-Cell.jp-mod-dropTarget[data-mosaic-drop-side='right']::after {\n  top: 0;\n  bottom: 0;\n  right: 0;\n  width: 3px;\n}\n\n/* -- flat vs floating presentation (the style dropdown) ------------------- */\n\n.mosaic-skeuomorphic .mosaic-Notebook {\n  background: transparent;\n  box-shadow: none;\n\n  --cell-margin: 10px;\n  --mosaic-gap: 14px;\n}\n\n.mosaic-skeuomorphic .mosaic-Notebook .jp-Cell {\n  background-color: rgb(255 255 255 / 3%);\n  box-shadow: 0 2px 7px 1px rgb(0 0 0 / 70%);\n  border-radius: 10px;\n}\n\n.mosaic-skeuomorphic .mosaic-Notebook.jp-ThemedContainer :not(.jp-Cell) {\n  /* darken the backdrop so the floating cells read as raised */\n  background-color: rgb(\n    from var(--jp-layout-color3) calc(r - 50) calc(g - 50) calc(b - 50)\n  );\n}\n\n/* the outer notebook's own padding is not useful once cells tile edge to edge */\ndiv .mosaic-Notebook .jp-WindowedPanel-viewport {\n  padding: var(--mosaic-edge-padding);\n}\n\n/* * puts cell handles (In [*]:) and output labels (Out [*]:) on the left */\n.mosaic-top-cell-handles .mosaic-Notebook .jp-OutputArea-promptOverlay {\n  width: 100%;\n  height: 100%;\n  max-height: 2.8rem !important;\n}\n.mosaic-top-cell-handles .mosaic-Notebook .jp-OutputArea-promptOverlay {\n  text-align: left;\n}\n.mosaic-top-cell-handles .mosaic-Notebook .jp-Cell .jp-InputArea,\n.mosaic-top-cell-handles .mosaic-Notebook .jp-OutputArea {\n  flex-direction: column !important;\n}\n/** \n * make the output view full width of the cell \n * (it usually leaves room for the output prompt, but we are putting that on top instead)\n */\n.mosaic-top-cell-handles .mosaic-Notebook .jp-OutputArea-child {\n  max-width: 100% !important;\n}\n.mosaic-top-cell-handles .mosaic-Notebook .prompt_container > .jp-InputPrompt {\n  text-align: left;\n  position: relative;\n  height: 2.8rem;\n  width: 100%;\n}\n.mosaic-top-cell-handles .mosaic-Notebook .jp-InputPrompt {\n  width: 100%;\n  /* height: 100%; */\n  text-align: left;\n  flex: 0 0 auto;\n  z-index: 2;\n}\n.mosaic-top-cell-handles .mosaic-Notebook .jp-InputArea-editor {\n  margin-left: 5px; /* spacing between collapser and editor */\n}\n\n/** makes sure the output is clickable */\n.mosaic-Notebook .jp-OutputArea {\n  z-index: 2 !important;\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=style_index_js.ad3de823cd0b28e33adb.js.map